...
// figma node: 2462:4176 Slot (18 variants)
...
export function Slot2(_p = {}) {
  ...
  const __body5 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          alignSelf: "stretch",
          height: "auto",
        }}>{props.icon1 ?? <IconButton variant={"fill"} color={"primary"} state={"default"} size={"md"} />}</div>
    </div>
  );
  const __body6 = () => (
    <div className={props.className} style={{
  ...
  const __impls = {
    ...
    // figma: variant=button, align=left
    "variant=button|align=left": __body4,
    // figma: variant=iconbutton, align=left
    "variant=iconbutton|align=left": __body5,
    // figma: variant=badge, align=left
    "variant=badge|align=left": __body6,
    // figma: variant=input, align=left
    "variant=input|align=left": __body7,
    // figma: variant=text, align=center
    "variant=text|align=center": __body8,
    // figma: variant=button, align=center
    "variant=button|align=center": __body9,
    // figma: variant=iconbutton, align=center
    "variant=iconbutton|align=center": __body10,
    // figma: variant=badge, align=center
    "variant=badge|align=center": __body11,
    // figma: variant=input, align=center
    "variant=input|align=center": __body12,
    // figma: variant=text, align=right
    "variant=text|align=right": __body13,
    // figma: variant=button, align=right
    "variant=button|align=right": __body14,
    // figma: variant=iconbutton, align=right
    "variant=iconbutton|align=right": __body15,
    // figma: variant=badge, align=right
    "variant=badge|align=right": __body16,
    // figma: variant=input, align=right
    "variant=input|align=right": __body17,
  };
