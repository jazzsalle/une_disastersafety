import { IconLine33 } from './IconLine33.jsx';

// figma node: 17:4726 가변 아이콘 (8 variants)
...
export function Component(_p = {}) {
  ...
  const __body6 = () => (
    <div className={props.className} style={{
      width: "calc(var(--sizing-icon-4xl) * 1px)",
      height: 36,
      display: "flex",
      flexDirection: "row",
      justifyContent: "center",
  ...
  const __body7 = () => (
    <div className={props.className} style={{
      width: "calc(var(--sizing-icon-5xl) * 1px)",
      height: 40,
      display: "flex",
      flexDirection: "row",
      justifyContent: "center",
