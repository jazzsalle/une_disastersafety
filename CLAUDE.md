...
- 설계 문서: `docs/00_사업수행계획서_분석.md`(사업 컨텍스트) → `DESIGN.md`(아키텍처) → `docs/01_기획서.md`, `docs/02_데이터분석.md`, `docs/03_화면설계.md`, `docs/05_VWorld_API_활용계획.md`(지도 API), `docs/06_UNI_RAG_챗봇_연동.md`(챗봇 API)
